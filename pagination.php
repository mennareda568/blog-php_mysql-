...
?>
                ...
                <div class="col-md-10 m-auto pt-5">
                    <div>
                        ...
                        ?>
                            ...
                            ?>
                                <img src="images/<?php echo $item['files'] ?>" width="70%" height="200" />
                            <?php
                            } ?>
                            ...
                            $name = $statment->fetch();
                            ?>
                            <h6><?php echo $name['title'] ?></h6>
                            <br>

                            <a href="?page=show&post_id=<?php echo $item['post_id'] ?>" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                            <?php
                            if ($_SESSION['userlogin_id'] == $item['user_id']) {
                            ?>
                                <h4 class="mt-3"><a href="?page=edit&post_id=<?php echo $item['post_id']?>" class="btn btn-success"><i class="fa-solid fa-pen-to-square"></i></a>
    ...
    <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            } elseif (count($words) < 3 || count($words) > 5) {
